...
#include "UnipassWebBrowser.generated.h"

/**
 *
 */
UCLASS()
class UNIPASSSDK_API UUnipassWebBrowser : public UWidget
{
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Unipass|Web Browser")
	...
	*/
	...
	UPROPERTY(BlueprintAssignable, Category = "Unipass|Web Browser|Event")
